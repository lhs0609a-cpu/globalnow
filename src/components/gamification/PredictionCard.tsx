  ...
  return (
    <div className="surface p-5">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-slate-500 t-body-sm">
          마감: {new Date(prediction.deadline).toLocaleDateString('ko-KR')}
        </span>
      </div>
      <h3 className="text-slate-100 font-semibold mb-1">{prediction.questionKo}</h3>
      {prediction.description && (
        <p className="text-slate-400 t-body mb-4">{prediction.description}</p>
      )}
      ...
      <p className="text-slate-500 t-body-sm mt-3 text-center">
