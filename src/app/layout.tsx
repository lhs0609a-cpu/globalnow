...
export const metadata: Metadata = {
  ...
  description: '전세계 주요 언론의 뉴스, 트렌드, 유머를 한 곳에서 한국어로. CEO를 위한 글로벌 뉴스 대시보드.',
  icons: { icon: '/favicon.ico' },
  openGraph: {
    title: 'GLOBALNOW - 글로벌 뉴스 대시보드',
    description: '전세계 주요 미디어의 뉴스, 트렌드, 시장 데이터를 AI가 분석하여 한국어로 제공합니다.',
    type: 'website',
    locale: 'ko_KR',
    siteName: 'GLOBALNOW',
  },
  twitter: {
    ...
    title: 'GLOBALNOW - 글로벌 뉴스 대시보드',
    description: '전세계 주요 언론의 뉴스를 한눈에. CEO를 위한 글로벌 뉴스 대시보드.',
  },
  robots: {
    index: true,
    follow: true,
